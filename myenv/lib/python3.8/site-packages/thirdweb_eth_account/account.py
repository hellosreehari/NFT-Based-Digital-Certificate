...
from thirdweb_eth_account._utils.legacy_transactions import (
    Transaction,
    vrs_from,
)
from thirdweb_eth_account._utils.signing import (
...
from thirdweb_eth_account._utils.typed_transactions import (
    TypedTransaction,
)
from thirdweb_eth_account.datastructures import (
    SignedMessage,
    SignedTransaction,
)
from thirdweb_eth_account.hdaccount import (
    ETHEREUM_DEFAULT_PATH,
    generate_mnemonic,
    key_from_seed,
    seed_from_mnemonic,
)
from thirdweb_eth_account.messages import (
    SignableMessage,
    _hash_eip191_message,
)
from thirdweb_eth_account.signers.local import (
    LocalAccount,
)
...
class Account(object):
    ...
    _default_kdf = os.getenv('thirdweb_eth_account_KDF', 'scrypt')
    ...
    def create(self, extra_entropy=''):
        r"""
        Creates a new private key, and returns it as a :class:`~thirdweb_eth_account.local.LocalAccount`.
        ...
        .. code-block:: python
            ...
            >>> from thirdweb_eth_account import Account
    ...
    def encrypt(cls, private_key, password, kdf=None, iterations=None):
        ...
        environment variable :envvar:`thirdweb_eth_account_KDF`. If that is not set, then
    ...
    def privateKeyToAccount(self, private_key):
        """
        .. CAUTION:: Deprecated for :meth:`~thirdweb_eth_account.account.Account.from_key`.
    ...
    def recover_message(self, signable_message: SignableMessage, vrs=None, signature=None):
        ...
        .. doctest:: python
            ...
            >>> from thirdweb_eth_account.messages import encode_defunct
            >>> from thirdweb_eth_account import Account
    ...
    def recoverHash(self, message_hash, vrs=None, signature=None):
        ...
        .. CAUTION:: Deprecated for :meth:`~thirdweb_eth_account.account.Account.recover_message`.
    ...
    def recoverTransaction(self, serialized_transaction):
        """
        .. CAUTION:: Deprecated for :meth:`~thirdweb_eth_account.account.Account.recover_transaction`.
            This method will be removed in v0.5
        """
        warnings.warn(
    ...
    def setKeyBackend(self, backend):
        """
        .. CAUTION:: Deprecated for :meth:`~thirdweb_eth_account.account.Account.set_key_backend`.
            This method will be removed in v0.5
        """
        warnings.warn(
    ...
    def sign_message(self, signable_message: SignableMessage, private_key):
        ...
        you can use :meth:`~thirdweb_eth_account.messages.encode_defunct`.
        ...
        :rtype: ~thirdweb_eth_account.datastructures.SignedMessage
    ...
    def signHash(self, message_hash, private_key):
        ...
        .. WARNING:: *Never* sign a hash that you didn't generate,
            ...
            Instead, prefer :meth:`~thirdweb_eth_account.account.Account.sign_message`,
            which cannot accidentally sign a transaction.

        .. CAUTION:: Deprecated for :meth:`~thirdweb_eth_account.account.Account.sign_message`.
    ...
    def signTransaction(self, transaction_dict, private_key):
        """
        .. CAUTION:: Deprecated for :meth:`~thirdweb_eth_account.account.Account.sign_transaction`.
            This method will be removed in v0.5
        """
        warnings.warn(
