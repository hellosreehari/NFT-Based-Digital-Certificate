...
from thirdweb_eth_account.signers.base import (
    BaseAccount,
)
...
class LocalAccount(BaseAccount):
    ...
    def __init__(self, key, account):
        ...
        :param ~thirdweb_eth_account.account.Account account: the key-unaware management API
        """
    ...
    def privateKey(self):
        """
        .. CAUTION:: Deprecated for :meth:`~thirdweb_eth_account.signers.local.LocalAccount.key`.
    ...
    def encrypt(self, password, kdf=None, iterations=None):
        ...
        :meth:`~thirdweb_eth_account.account.Account.encrypt`, but without a private key argument.
        """
    ...
    def sign_message(self, signable_message):
        ...
        This uses the same structure as in
        :meth:`~thirdweb_eth_account.account.Account.sign_message`, but without a private key argument.
        """
