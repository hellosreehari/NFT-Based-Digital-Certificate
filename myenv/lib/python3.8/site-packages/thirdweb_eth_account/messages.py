...
from thirdweb_eth_account._utils.structured_data.hashing import (
    hash_domain,
    hash_message as hash_eip712_message,
    load_and_validate_structured_message,
)
from thirdweb_eth_account._utils.structured_data.validation import (
    validate_structured_data,
)
from thirdweb_eth_account._utils.validation import (
    is_valid_address,
)
...
def defunct_hash_message(
    ...
    .. CAUTION:: Intented for use with the deprecated :meth:`thirdweb_eth_account.account.Account.signHash`.
